...
// Evidence here raises no level by itself. A statement family reaches L3 only when
// the pinned serializer shape, the pinned runtime consumer and at least one
// sanitised editor-saved occurrence agree, and its tests pass on that occurrence.
// A disagreement is an explicit evidence gap and caps the occurrence below L3.
[
  provenance: [
  ...
  // Planned A2 fixtures. A reference names a piston (both captures), a piston capture, or all.
  fixtureStems: ['l3-01', 'l3-02', 'l3-03', 'l3-04', 'l3-05', 'l3-06', 'l3-07', 'l3-08'],
  captureKinds: ['first-save', 'round-trip'],
  branchGaps: ['needs-physical-device', 'not-in-matrix', 'observed-at-capture'],

  // Every optional or conditional branch and the fixture evidence planned for it. A3 checks each
  // named fixture really takes the branch; a branch left with a gap, or whose fixture does not take
  // it, caps every occurrence that takes that branch at L2 whatever the family ceiling.
  branchEvidence: [
    [structure: 'statement', key: '$', branch: 'present', fixtures: ['all.round-trip']],
    [structure: 'statement', key: '$', branch: 'absent', fixtures: ['all.first-save']],
    [structure: 'statement', key: 'a', branch: 'value:0', fixtures: ['l3-01', 'l3-02', 'l3-03', 'l3-04', 'l3-05', 'l3-08']],
    [structure: 'statement', key: 'a', branch: 'value:1', fixtures: ['l3-06', 'l3-07']],
    [structure: 'statement', key: 'tep', branch: 'present', fixtures: ['l3-08']],
    [structure: 'statement', key: 'tep', branch: 'absent', fixtures: ['all']],
    [structure: 'statement', key: 'tep', branch: 'value:c', fixtures: ['l3-08']],
    [structure: 'statement', key: 'tep', branch: 'value:p', fixtures: ['l3-08']],
    [structure: 'statement', key: 'tep', branch: 'value:b', fixtures: ['l3-08']],
    [structure: 'statement', key: 'tsp', branch: 'present', fixtures: ['l3-08']],
    [structure: 'statement', key: 'tsp', branch: 'absent', fixtures: ['all']],
    [structure: 'statement', key: 'tsp', branch: 'value:a', fixtures: ['l3-08']],
    [structure: 'statement', key: 'tcp', branch: 'present', fixtures: ['all']],
    [structure: 'statement', key: 'tcp', branch: 'absent', fixtures: ['l3-08']],
    [structure: 'statement', key: 'tcp', branch: 'value:c', fixtures: ['all']],
    [structure: 'statement', key: 'tcp', branch: 'value:p', fixtures: ['l3-08']],
    [structure: 'statement', key: 'tcp', branch: 'value:b', fixtures: ['l3-08']],
    [structure: 'statement', key: 'rn', branch: 'present', fixtures: ['l3-08']],
    [structure: 'statement', key: 'rn', branch: 'absent', fixtures: ['all']],
    [structure: 'statement', key: 'di', branch: 'present', fixtures: ['l3-08']],
    [structure: 'statement', key: 'di', branch: 'absent', fixtures: ['all']],
    [structure: 'statement', key: 'z', branch: 'present', fixtures: ['all']],
    [structure: 'statement', key: 'z', branch: 'absent', fixtures: ['all']],
    [structure: 'statement', key: 'sm', branch: 'present', fixtures: ['l3-01']],
    [structure: 'statement', key: 'sm', branch: 'absent', fixtures: ['all']],
    [structure: 'wc.statement.if', key: 'n', branch: 'present', fixtures: ['l3-01']],
    [structure: 'wc.statement.if', key: 'n', branch: 'absent', fixtures: ['l3-01', 'l3-02']],
    [structure: 'wc.statement.while', key: 'n', branch: 'present', fixtures: ['l3-04']],
    [structure: 'wc.statement.while', key: 'n', branch: 'absent', fixtures: ['l3-04']],
    [structure: 'wc.statement.repeat', key: 'n', branch: 'present', fixtures: ['l3-04']],
    [structure: 'wc.statement.repeat', key: 'n', branch: 'absent', fixtures: ['l3-04']],
    [structure: 'wc.statement.every', key: 'lo2', branch: 'consumed', fixtures: ['l3-06']],
    [structure: 'wc.statement.every', key: 'lo2', branch: 'unconsumed', fixtures: ['l3-06']],
    [structure: 'wc.statement.every', key: 'lo3', branch: 'consumed', fixtures: ['l3-06']],
    [structure: 'wc.statement.every', key: 'lo3', branch: 'unconsumed', fixtures: ['l3-06']],
    [structure: 'wc.statement.on', key: 'o', branch: 'value:or', fixtures: ['l3-07']],
    [structure: 'wc.statement.each', key: 'x', branch: 'present', fixtures: ['l3-05']],
    [structure: 'wc.statement.each', key: 'x', branch: 'absent', gap: 'not-in-matrix'],
    [structure: 'wc.statement.for', key: 'x', branch: 'present', fixtures: ['l3-05']],
    [structure: 'wc.statement.for', key: 'x', branch: 'absent', gap: 'not-in-matrix'],
    [structure: 'wc.statement.switch', key: 'ctp', branch: 'value:i', fixtures: ['l3-03']],
    [structure: 'wc.statement.switch', key: 'ctp', branch: 'value:e', fixtures: ['l3-03']],
    [structure: 'wc.statement.switch', key: 'ct', branch: 'present', fixtures: ['l3-03.round-trip']],
    [structure: 'wc.statement.switch', key: 'ct', branch: 'absent', fixtures: ['l3-03.first-save']],
    [structure: 'wc.statement.switch', key: 'ct', branch: 'value:c', fixtures: ['l3-03.round-trip']],
    [structure: 'wc.statement.switch', key: 's', branch: 'present', fixtures: ['l3-03.round-trip']],
    [structure: 'wc.statement.switch', key: 's', branch: 'absent', fixtures: ['l3-03.first-save']],
    [structure: 'elseif', key: '$', branch: 'present', fixtures: ['l3-01.round-trip']],
    [structure: 'elseif', key: '$', branch: 'absent', fixtures: ['l3-01.first-save']],
    [structure: 'elseif', key: 'n', branch: 'present', fixtures: ['l3-01']],
    [structure: 'elseif', key: 'n', branch: 'absent', fixtures: ['l3-01']],
    [structure: 'case', key: '$', branch: 'present', fixtures: ['l3-03.round-trip']],
    [structure: 'case', key: '$', branch: 'absent', fixtures: ['l3-03.first-save']],
    [structure: 'case', key: 't', branch: 'value:s', fixtures: ['l3-03']],
    [structure: 'case', key: 't', branch: 'value:r', fixtures: ['l3-03']],
    [structure: 'case', key: 'ro2', branch: 'consumed', fixtures: ['l3-03']],
    [structure: 'case', key: 'ro2', branch: 'unconsumed', fixtures: ['l3-03']],
    [structure: 'case', key: 'z', branch: 'present', fixtures: ['l3-03']],
    [structure: 'case', key: 'z', branch: 'absent', fixtures: ['l3-03']],
    [structure: 'event', key: '$', branch: 'present', fixtures: ['l3-07.round-trip']],
    [structure: 'event', key: '$', branch: 'absent', fixtures: ['l3-07.first-save']],
    [structure: 'event', key: 't', branch: 'value:event', fixtures: ['l3-07']],
    [structure: 'event', key: 'z', branch: 'present', fixtures: ['l3-07']],
    [structure: 'event', key: 'z', branch: 'absent', fixtures: ['l3-07']],
    [structure: 'event', key: 'ct', branch: 'present', fixtures: ['l3-07.round-trip']],
    [structure: 'event', key: 'ct', branch: 'absent', fixtures: ['l3-07.first-save']],
    [structure: 'event', key: 'ct', branch: 'value:t', fixtures: ['l3-07.round-trip']],
    [structure: 'event', key: 's', branch: 'present', fixtures: ['l3-07.round-trip']],
    [structure: 'event', key: 's', branch: 'absent', fixtures: ['l3-07.first-save']],
    [structure: 'task', key: '$', branch: 'present', fixtures: ['all.round-trip']],
    [structure: 'task', key: '$', branch: 'absent', fixtures: ['all.first-save']],
    [structure: 'task', key: 'cm', branch: 'present', gap: 'needs-physical-device'],
    [structure: 'task', key: 'cm', branch: 'absent', fixtures: ['all']],
    [structure: 'task', key: 'a', branch: 'present', gap: 'observed-at-capture'],
    [structure: 'task', key: 'a', branch: 'absent', gap: 'observed-at-capture'],
    [structure: 'task', key: 'm', branch: 'present', fixtures: ['l3-08']],
    [structure: 'task', key: 'm', branch: 'absent', fixtures: ['all']],
    [structure: 'task', key: 'z', branch: 'present', fixtures: ['l3-08']],
    [structure: 'task', key: 'z', branch: 'absent', fixtures: ['all']],
    [structure: 'condition', key: '$', branch: 'present', fixtures: ['l3-01.round-trip', 'l3-02.round-trip', 'l3-04.round-trip']],
    [structure: 'condition', key: '$', branch: 'absent', fixtures: ['l3-01.first-save', 'l3-02.first-save', 'l3-04.first-save']],
    [structure: 'condition', key: 'z', branch: 'present', fixtures: ['l3-01']],
    [structure: 'condition', key: 'z', branch: 'absent', fixtures: ['l3-01', 'l3-02']],
    [structure: 'condition', key: 'ct', branch: 'present', fixtures: ['l3-01.round-trip', 'l3-02.round-trip']],
    [structure: 'condition', key: 'ct', branch: 'absent', fixtures: ['l3-01.first-save', 'l3-02.first-save']],
    [structure: 'condition', key: 'ct', branch: 'value:t', fixtures: ['l3-02.round-trip']],
    [structure: 'condition', key: 'ct', branch: 'value:c', fixtures: ['l3-01.round-trip']],
    [structure: 'condition', key: 's', branch: 'present', gap: 'observed-at-capture'],
    [structure: 'condition', key: 's', branch: 'absent', fixtures: ['l3-01.first-save']],
    [structure: 'condition', key: 'wd', branch: 'present', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wd', branch: 'retained', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wd', branch: 'consumed', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wd', branch: 'unconsumed', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wt', branch: 'present', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wt', branch: 'retained', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wt', branch: 'value:l', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wt', branch: 'value:s', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wt', branch: 'value:n', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wt', branch: 'consumed', fixtures: ['l3-02']],
    [structure: 'condition', key: 'wt', branch: 'unconsumed', fixtures: ['l3-02']],
    [structure: 'group', key: '$', branch: 'present', fixtures: ['l3-01.round-trip']],
    [structure: 'group', key: '$', branch: 'absent', fixtures: ['l3-01.first-save']],
    [structure: 'group', key: 'n', branch: 'present', fixtures: ['l3-01']],
    [structure: 'group', key: 'n', branch: 'absent', fixtures: ['l3-02']],
    [structure: 'group', key: 'z', branch: 'present', fixtures: ['l3-01']],
    [structure: 'group', key: 'z', branch: 'absent', fixtures: ['l3-02']],
    [structure: 'group', key: 'wd', branch: 'present', fixtures: ['l3-02']],
    [structure: 'group', key: 'wd', branch: 'retained', gap: 'not-in-matrix'],
    [structure: 'group', key: 'wd', branch: 'consumed', fixtures: ['l3-02']],
    [structure: 'group', key: 'wd', branch: 'unconsumed', gap: 'not-in-matrix'],
    [structure: 'group', key: 'wt', branch: 'present', fixtures: ['l3-02']],
    [structure: 'group', key: 'wt', branch: 'retained', gap: 'not-in-matrix'],
    [structure: 'group', key: 'wt', branch: 'value:l', gap: 'not-in-matrix'],
    [structure: 'group', key: 'wt', branch: 'value:s', fixtures: ['l3-02']],
    [structure: 'group', key: 'wt', branch: 'value:n', gap: 'not-in-matrix'],
    [structure: 'group', key: 'wt', branch: 'consumed', fixtures: ['l3-02']],
